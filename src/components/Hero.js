  ...
  return (
    <div className="w-full h-screen bg-zinc-200 flex flex-col justify-between">
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start px-2 w-full py-8">
          <p className="text-2xl">Uniqie Sequencing & Production</p>
          <h1 className="py-3 text-5xl md:text-7xl font-bold">Cloud Manager</h1>
          <p className="text-2xl">This is Tech Brand .</p>
          <button className="py-3 px-6 sm:w-[60%]">Get started.</button>
        </div>
        <div>
          <img className="w-full" src={bgImage} alt="error"></img>
        </div>
        <div
